...
pub(crate) unsafe fn enet_crc32(mut buffers: *const ENetBuffer, mut bufferCount: usize) -> u32 {
...
mod test {
    ...
    fn crc32() {
        ...
        assert_eq!(unsafe { enet_crc32(&mut buffer, 1) }, 3314076223);

        let mut data1: [u8; 8] = [1, 2, 3, 4, 5, 6, 7, 8];
        let mut data2: [u8; 8] = [8, 7, 6, 5, 4, 3, 2, 1];
        let mut buffers = [
            ENetBuffer {
        ...
        assert_eq!(unsafe { enet_crc32(buffers.as_mut_ptr(), 2) }, 1712484799);
    }
}
